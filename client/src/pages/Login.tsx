...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex flex-col justify-center p-6">
      <ConnectionStatus />
      ...
      <form onSubmit={handleEmailLogin} className="space-y-6">
        <div>
          ...
          <Input
            ...
            className="bg-white text-gray-900 text-base h-12"
            required
          />
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative">
            <Input
              ...
              className="bg-white text-gray-900 text-base h-12 pr-12"
            />
            <button
              type="button"
        ...
        <Button
          ...
          className="w-full bg-white text-blue-600 hover:bg-gray-50 font-semibold text-lg h-12 shadow-lg"
        >
          {isLoggingIn ? "Entrando..." : "Entrar com Email/Senha"}
        </Button>
        ...
        <Button
          ...
          className="w-full bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold text-lg h-12"
        >
